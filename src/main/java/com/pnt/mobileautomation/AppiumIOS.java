...
public class AppiumIOS {
    ...
    public static void main(String[] args) throws MalformedURLException, InterruptedException {
        ...
        cap.setCapability(MobileCapabilityType.DEVICE_NAME, "");     // will get the informations from the developercap.setCapability(MobileCapabilityType.APP_ACTIVITY,"");
        ...
        driver.findElement(By.xpath("//android.widget.TextView[@text='View Accounts']")).click();
